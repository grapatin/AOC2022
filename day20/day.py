...
def problem_a(input_string, expected_result):
    ...
    for rowId in range(1, len(rows)):
        number = int(rows[rowId])*decryptKey
    ...
    if solution == expected_result:
        print("Correct solution found Part 2:", solution)
    else:
        print("Incorrect solution, we got:", solution, "expected:", expected_result)

problem_a(EXAMPLE_INPUT1, 1623178306)
problem_a(PROGBLEM_INPUT_TXT, 912226207972) #19559)
print("\n")
